...
if (require.main === module) {
  ...
  const tasksPath = proposalName ? path.join(__dirname, '..', 'openspec', 'changes', proposalName, 'tasks.md') : path.join(__dirname, '..', 'openspec', 'changes', 'integrate-beads-sync', 'tasks.md');
